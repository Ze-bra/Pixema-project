...
const FilmCard = (props: { film: MovieDtoV13 }) => {
    ...
    return (
        <div className={styles.filmCard}>
            ...
            <Image className={[styles.filmCardImg, "float-start"].join(' ')} src={props.film.poster?.previewUrl} alt="" />

            <Link className={styles.filmCardTitle} to={`${RoutesConstants.Film}/${props.film.id}`}>{props.film.name}</Link>
